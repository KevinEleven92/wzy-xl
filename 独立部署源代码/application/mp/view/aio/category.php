                ...
                _html += '<ion-card class="wzy-subject-item" data-subject-id="' + itemList[i].id +'">' +
                        '<div class="wzy-subject-brief">' + 
                            ...
                            '<div class="wzy-subject-right">' +
                                '<div class="wzy-subject-name"><a href="<?=url('mp/Aio/detail')?>?id=' + itemList[i].id + '">' + itemList[i].title + '</a></div>' +
                                ...
                                '<div class="wzy-subject-text">' +
                                    '<p><ion-text color="success">' + itemList[i].items + '</ion-text>道题目</p>' +
                                    '<p><ion-text color="secondary">' + itemList[i].participants + '</ion-text>人已测</p>' +
                                '</div>' +
                            '</div>' +
                        '</div>' +
                        '<div class="wzy-subject-opt">' +
                            '<ion-button size="small" href="<?=url('mp/Aio/detail')?>?id=' + itemList[i].id + '" color="action" size="default" fill="solid">查看详情<ion-icon name="arrow-forward-circle-outline" slot="end"></ion-icon></ion-button>' +
                        '</div>' +
                    '</ion-card>';
            }
            return _html;
