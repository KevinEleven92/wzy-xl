        ...
        <ul class="wzy-subject-list">
            ...
            <ion-card class="wzy-subject-item ion-margin">
                ...
                <div class="wzy-subject-opt">
                    <ion-button href="<?=url('mp/Subject/combination_result',['cb_order_id'=>$row['id']])?>" fill="outline" size="small" color="action">
    ...
    <div id="tab-done" style="display: none;">
        <ul class="wzy-subject-list">
            ...
            <ion-card class="wzy-subject-item ion-margin">
                ...
                <div class="wzy-subject-opt">
                    <ion-button href="<?=url('mp/Subject/reportGroup',['cb_order_id'=>$rowCompleted['id']])?>" fill="outline" size="small" color="action">
